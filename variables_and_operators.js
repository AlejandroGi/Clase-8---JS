console.log('variables_and_operators');
...
var string1, string2, stringTot;

string1 ='hola'
string2 ='adios'

strintTot = string1 + ', persona que lee. ' + string2;
console.log(strintTot);
...
var string1, string2, stringLenght;

string1 ='hola';
string2 ='adios';
stringLenght = (string1.length+string2.length);
console.log('El largo total es ' + stringLenght);
